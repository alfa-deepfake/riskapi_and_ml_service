...
const FLOW = [
  ...
  },
  {
    ...
    value: "жест",
    hint: "Коснитесь показанной точки любым пальцем или даже ладонью, удерживая лицо внутри овала.",
  ...
  },
  {
    ...
    value: "пульс",
    hint: "Не двигайтесь: экран станет белым и подсветит лицо на время замера пульса.",
